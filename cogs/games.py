...
class Games(commands.Cog):
    ...
    @cog_ext.cog_slash(name="bjhelp",
                       description="To understand the rules of bj.")
    async def _bjhelp(self, ctx: SlashContext):
    ...
    @cog_ext.cog_slash(name="bj",
                       description="Beat your friends in this card game of horror.")
    async def _blackjack(self, ctx: SlashContext):
        players = []
        ...
        msg = await ctx.send(embed=nextcord.Embed(title=f"The cards will be dealt in 20 seconds",
        ...
        try:
            ...
            for player in players:
                try:
                    ...
                    await to_edit.edit(embed=nextcord.Embed(title=f"It is {player}'s turn", description=f"{string}",
                                                            color=nextcord.Color.random()),
                                       components=[
                                           Button(style=ButtonStyle.blue, label="Hit"),
                                           Button(style=ButtonStyle.blue, label="Stand")
                                       ])
                    response = await self.bot.wait_for("button_click", timeout=20, check=check)
            ...
            if len(players) > 1:
                ...
                embed = nextcord.Embed(title=f"The winner is {dict['player']}",
                                       ...
                                       color=nextcord.Color.random())
                embed.set_footer(text=f"Tip: Use /bjhelp if you do not understand the game.")
                await ctx.send(embed=embed)
                ...
                embed = nextcord.Embed(title=f"You all got burst",
                                       ...
                                       color=nextcord.Color.random())
                embed.set_footer(text="Tip: Use /bjhelp if you do not understand the game.")
                await ctx.send(embed=embed)
